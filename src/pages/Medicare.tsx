  ...
  return (
    <div className="relative min-h-screen overflow-hidden medicare-bg">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 opacity-70 mix-blend-multiply">
          <div className="absolute inset-0 opacity-40 mix-blend-multiply bg-[radial-gradient(circle_at_top_right,rgba(67,56,202,0.1),transparent_50%),radial-gradient(circle_at_bottom_left,rgba(79,70,229,0.1),transparent_50%)]"></div>
        </div>
      </div>
      
      <MouseFollower />
      
      <div className="sticky top-0 left-0 right-0 z-50 bg-white/90 shadow-md backdrop-blur-md dark:bg-background/80">
        <NavigationHeader />
      </div>
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance bg-gradient-to-r from-blue-600 via-medical to-purple-600 bg-clip-text text-transparent">
            Medicare Services
          </h1>
